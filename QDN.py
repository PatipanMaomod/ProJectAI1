...
def save_model(agent, path=r"D:\model_Ai\model\model.pth", target_path=r"D:\model_Ai\model\target_model.pth", epsilon_path=r"D:\model_Ai\model\epsilon.txt"):
...
def load_model(agent, path=r"D:\model_Ai\model\model.pth", target_path=r"D:\model_Ai\model\target_model.pth", epsilon_path=r"D:\model_Ai\model\epsilon.txt"):
